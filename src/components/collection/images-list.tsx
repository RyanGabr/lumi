import { useGetImagesByCollectionId } from "@/hooks/use-get-images";
...
export function ImagesList() {
  ...
  const { data: images, isFetching } = useGetImagesByCollectionId(collectionId);
    ...
    return (
      <div className="select-none w-full h-96 flex flex-col gap-2 items-center justify-center">
        ...
        <p className="text-sm text-foreground/50">
          Adicione uma imagem com esta coleção.
        </p>
      </div>
    );
  }
